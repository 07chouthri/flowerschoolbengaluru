                    ...
                    {products && Array.isArray(products) && products.map((product) => (
                      ...
                      >
                        ...
                        <div className="p-4 space-y-2">
                          ...
                          <p className="text-sm text-muted-foreground line-clamp-1 font-sans">{product.category || 'Uncategorized'}</p>
                          <div className="flex items-center justify-between">
            ...
            {selectedProduct && (
              <>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-4 items-center gap-2 lg:gap-4">
                  ...
                  <div className="sm:col-span-3 text-sm lg:text-base">{selectedProduct.category || 'N/A'}</div>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-4 items-center gap-2 lg:gap-4">
